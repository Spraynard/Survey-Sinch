 ...
 * 
 */
const SurveyorButton = ({ type = "button", children, ...rest } : Props) => {
...
const SurveyorPreviousButton = ( props ) => 
    <SurveyorButton aria-label="Previous Question" {...props}>
        <FontAwesomeIcon icon={faArrowLeft}/>
    </SurveyorButton>

const SurveyorNextButton = ( props ) => 
    <SurveyorButton aria-label="Next Question" {...props}>
        <FontAwesomeIcon icon={faArrowRight}/>
    </SurveyorButton>

const SurveyorSubmitButton = ( props ) => 
    <SurveyorButton type="submit" aria-label="Submit Survey" autoMarginLeft={true} {...props}>
        <FontAwesomeIcon icon={faFile}/>
    </SurveyorButton>


export { SurveyorPreviousButton, SurveyorNextButton, SurveyorSubmitButton }